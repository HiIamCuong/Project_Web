			...
			<div class="col-md-7 col-sm-7">
				...
				<form action="${pageContext.request.contextPath}/admin/user/add"
					...
					<fieldset>
						...
						<div class="form-group">
							<label for="role" class="col-lg-4 control-label"> Role <span
								class="require">*</span>
							</label>
							<div class="col-lg-8">
								<input type="radio" class="form-control" name="role" value="Admin"> Admin    
								&emsp;
								<input type="radio" class="form-control" name="role" value="User"> User
